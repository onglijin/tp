...
public class ParserUtil {
        ...
        public static final String MESSAGE_INVALID_INDEX = "Invalid index. Index cannot be empty, " +
                "and can only take integer value in range [1,13].\n" +
                "Please try again!";

        public static final String MESSAGE_INVALID_DEADLINE = "Invalid deadline. A deadline should be in " +
